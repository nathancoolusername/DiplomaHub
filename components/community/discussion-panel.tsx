...
export default function Panel({discussion}:Props) {
    ...
    return (<div className="cursor-pointer hover:drop-shadow-xl/10 transition flex flex-col bg-surface-container-lowest border-1 border-outline-variant p-md rounded-md gap-lg">
                ...
                <div><h1 className="text-headline-md font-serif">{discussion.title}</h1></div>
                ...
                <div className="flex flex-row gap-md bg-surface-container-low py-md px-sm rounded-xl items-center">
                    <div className="border-1 border-outline-variant rounded-[50%] h-8 w-8 items-center justify-items-center pt-1 bg-secondary-container"><h1>NP</h1></div>
                    <h1 className="italic text-on-surface-variant text-body-sm">"Had the exact same problem, please help🙏🙏"</h1>
                ...
                <div className="border-t-1 border-outline-variant mt-auto pt-md flex flex-row">
                    <div className="flex flex-row items-center">
                        <div className="text-on-surface-variant transition hover:text-primary hover:bg-surface-container p-sm rounded-xl"><Heart /></div>
                        <h1 className="text-on-surface-variant text-body-lg ml-sm mr-md">{discussion.like_count}</h1>
                        <div className="text-on-surface-variant transition hover:text-primary hover:bg-surface-container p-sm rounded-xl"><MessageSquare/></div>
                        <h1 className="text-on-surface-variant text-body-lg ml-sm">{discussion.reply_count}</h1>
                    </div>
