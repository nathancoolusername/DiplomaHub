...
export default function HubError({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-margin py-20 px-md text-center min-h-[60vh]">
      ...
      <h1 className="text-headline-lg font-serif font-bold">The Hub couldn&apos;t load</h1>
      <p className="text-on-surface-variant text-body-lg max-w-150">
        Your data is safe — this was just a hiccup loading the page. Try again.
      </p>
      ...
      {error.digest && (
        <p className="text-label-sm text-on-surface-variant">
          Reference code: <span className="font-mono">{error.digest}</span> — include this if you email{" "}
          <a href="mailto:info@diplomahub.org" className="underline hover:text-primary">
            info@diplomahub.org
          </a>
        </p>
      )}
