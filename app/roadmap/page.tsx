      ...
      <div className="flex flex-col lg:flex-row gap-margin">
        ...
        <div className="flex flex-row gap-margin grow">
          <div className="hidden lg:flex flex-col gap-[300px]">
            ...
            <WandSparkles
              size={30}
              className="p-1 bg-primary rounded-xl text-on-primary mb-12"
            />
            <Clock
              size={30}
          ...
          <div className="flex flex-col gap-margin grow">
            <div className="flex flex-col w-full bg-surface-container-lowest p-lg rounded-xl border-1 border-outline-variant gap-md  hover:border-primary hover:drop-shadow-xl/10 transition">
              <div className="justify-between flex flex-row items-center ">
                <h1 className="text-headline-md text-secondary uppercase rounded-xl">
                  Released Sept 2026
                </h1>
                <Medal size={30} className="text-secondary ml-auto" />
              </div>
              <h1 className="text-headline-lg font-serif font-bold">
                IB Pro Status & Gamification
              </h1>
              <h1 className="text-on-surface-container text-body-lg">
                Developed a robust reputation system where users earn "Scholarly
              ...
              <div className="gap-md flex flex-row flex-wrap items-center">
                ...
                <div className="rounded-xl p-md bg-secondary-container flex flex-row gap-sm items-center">
                  <h1 className="text-secondary text-body-lg">
                    XP Leaderboards
                  </h1>
                  <Podium size={30} className="text-secondary" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full bg-surface-container-lowest p-lg rounded-xl border-1 border-outline-variant gap-gutter border-l-5 border-l-primary hover:border-primary hover:drop-shadow-xl/10 transition">
              <div className="justify-between flex flex-row items-center">
                <h1 className="text-headline-md text-primary uppercase rounded-xl">
                  Active development
                </h1>
              ...
              <h1 className="text-on-surface-container text-body-lg">
                Launching the integrated news portal sourcing official updates
              ...
              <div className="gap-md flex flex-row flex-wrap items-center">
                ...
                <div className="rounded-xl p-md bg-surface-container-low flex flex-row gap-sm items-center">
                  <h1 className="text-primary text-body-lg">Quickly Updated</h1>
            ...
            <div className="flex flex-col w-full bg-inverse-on-surface p-lg rounded-xl border-1 border-outline-variant gap-md hover:bg-surface-container-lowest hover:drop-shadow-xl/10 transition">
              <div className="justify-between flex flex-row items-center">
                <h1 className="text-headline-md text-on-surface-variant uppercase rounded-xl">
                  Estimated Jan 2027
                </h1>
                <Medal size={30} className="text-on-surface-variant ml-auto" />
              </div>
              <h1 className="text-headline-lg font-serif text-on-surface-variant font-bold">
                University Section
              </h1>
              <h1 className="text-on-surface-variant text-body-lg">
                Brand new page for university resources, discussions and much
                more, tailored to IB students around the world.
              </h1>
            </div>
          </div>
        </div>
