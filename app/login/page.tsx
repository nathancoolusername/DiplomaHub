...
export default function LoginPage() {
  ...
  return (
    <div className="px-[600px] py-20 bg-surface-container h-full flex flex-col gap-margin">
      <Link href="/">
      ...
      <div className="bg-surface-container-lowest p-margin border-1 border-outline-variant rounded-xl flex flex-col gap-margin">
        ...
        <form action={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              type="email"
              required
              className="w-92 border rounded-lg px-3 py-2"
            />
          </div>
          <div>
            <label className="block text-body-lg font-medium mb-1">
